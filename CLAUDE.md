...
Test sayısı **441**, hepsi geçiyor. Ayrıntılı durum için **her zaman
...
**Testleri çalıştır.** Değişiklikten sonra `cd server && npm test` — 441 test,
...
**Kanca ofis ağında da çalışır.** 441 testin hiçbiri veritabanı istemiyor;
