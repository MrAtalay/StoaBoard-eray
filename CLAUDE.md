...
Test sayısı **446**, hepsi geçiyor. Ayrıntılı durum için **her zaman
...
**Testleri çalıştır.** Değişiklikten sonra `cd server && npm test` — 446 test,
...
**Kanca ofis ağında da çalışır.** 446 testin hiçbiri veritabanı istemiyor;
