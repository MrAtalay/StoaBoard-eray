...
Test sayısı **438**, hepsi geçiyor. Ayrıntılı durum için **her zaman
...
**Testleri çalıştır.** Değişiklikten sonra `cd server && npm test` — 438 test,
...
**Kanca ofis ağında da çalışır.** 438 testin hiçbiri veritabanı istemiyor;
