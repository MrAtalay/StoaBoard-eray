...
Test sayısı **428**, hepsi geçiyor. Ayrıntılı durum için **her zaman
...
**Testleri çalıştır.** Değişiklikten sonra `cd server && npm test` — 428 test,
...
**Kanca ofis ağında da çalışır.** 428 testin hiçbiri veritabanı istemiyor;
